...
def building(str):
    ...
    we use ascii code because we cannot import string library the ord function convert character to ascii
    """
    counts = {
        "upper" : 0,
        "lower" : 0,
    ...
    for char in str:
        ...
        if 65 <= ascii_code <= 90:
            ...
            counts["spaces"] += 1
        elif (33 <= ascii_code <= 47) or (58 <= ascii_code <= 64) or (91 <= ascii_code <= 96) or (123 <= ascii_code <= 126): 
